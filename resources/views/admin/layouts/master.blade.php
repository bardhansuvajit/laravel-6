...
<body class="hold-transition sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="image">
                <img src="{{ asset(Auth::guard('admin')->user()->image_path) }}" class="img-circle elevation-2" alt="User Image">
                </div>
                <div class="info">
    ...
    <div id="toastAlert" style="display:none"></div>
    ...
    <script>
        function toastFire(msg, type) {
            if(type === 'failure') msg = `<i class="fas fa-info-circle"></i> ${msg}`;
            $('#toastAlert').html(msg).show();
            setTimeout(() => {
                $('#toastAlert').html('').hide();
            }, 2000);
        }
    </script>
