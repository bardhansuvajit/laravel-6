                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('user.create') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <input id="last_name" type="text" class="form-control @error('last_name') is-invalid @enderror" name="last_name" value="{{ old('last_name') }}" placeholder="Last name"  autocomplete="last_name">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                @error('pasModelssword_confirmation')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                @enderror
